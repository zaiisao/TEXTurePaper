...
class AttentionControlEdit(AttentionStore, abc.ABC):
    ...
    def __init__(self, prompts, num_steps: int,
                 ...
                 *args, **kwargs):
        super(AttentionControlEdit, self).__init__(*args, **kwargs)
...
class AttentionReplace(AttentionControlEdit):
    ...
    def __init__(self, prompts, num_steps: int, cross_replace_steps: float, self_replace_steps: float,
        ...
        super(AttentionReplace, self).__init__(prompts, num_steps, cross_replace_steps, self_replace_steps, local_blend, *args, **kwargs)
        self.mapper = seq_aligner.get_replacement_mapper(prompts, self.tokenizer).to(self.device)
...
class AttentionRefine(AttentionControlEdit):
    ...
    def __init__(self, prompts, num_steps: int, cross_replace_steps: float, self_replace_steps: float,
                 local_blend: Optional[LocalBlend] = None,
                 *args, **kwargs):
        super(AttentionRefine, self).__init__(prompts, num_steps, cross_replace_steps, self_replace_steps, local_blend, *args, **kwargs)
...
class AttentionReweight(AttentionControlEdit):
    ...
    def __init__(self, prompts, num_steps: int, cross_replace_steps: float, self_replace_steps: float, equalizer,
                 ...
                 *args, **kwargs):
        super(AttentionReweight, self).__init__(prompts, num_steps, cross_replace_steps, self_replace_steps, local_blend, *args, **kwargs)
...
if __name__ == "__main__":
    ...
    # prompts = ["a photo of spiderman, back view"]
    # controller = AttentionStore()
    # image, x_t = run_and_display(prompts, controller, latent=None, run_baseline=False, generator=g_cpu)
    # show_cross_attention(controller, res=16, from_where=("up", "down"))

    # prompts = ["a photo of spiderman, back view"] * 2

    # ### pay 3 times more attention to the word "smiling"
    # equalizer = get_equalizer(prompts[1], ("back",), (5,))
